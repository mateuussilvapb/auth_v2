...
- [ ] CRUD de tenants, sistemas, perfis, usuários (tenants e sistemas feitos —
      `AdminApiService`, `/console/tenants`, `/console/tenants/:tenantId/systems`; perfis
      e usuários pendentes)
