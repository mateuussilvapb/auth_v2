-- Schema oficial do Spring Authorization Server (oauth2-authorization-schema.sql e
-- oauth2-authorization-consent-schema.sql), sem modificações estruturais — apenas
-- adaptado para PostgreSQL conforme a nota do próprio schema: blob -> text,
-- timestamp -> timestamptz. Consumido por JdbcOAuth2AuthorizationService (Fase 6).
-- Não usar oauth2_registered_client: os clients vêm da tabela "system" (seção 4.3).
